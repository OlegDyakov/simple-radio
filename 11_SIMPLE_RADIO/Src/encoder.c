...
#define FREQ_MAX    280  // Максимальное значение частоты KHz
...
/* Подключение выхода энкодера A (PA6) и B (PA7) к таймеру TIM3 */
 ...
 /*  Настройка таймера TIM3 на работу с энкодером */
	 ...
	 NVIC_IPR7 = 0x00001000; // Установка приоритета  1 для прерывания 29.
 ...
 /*  Настройка  кнопки BUT энкодера */
	 ...
	 NVIC_IPR5 = 0x10000000; 		  // Установка приоритета  1 для прерывания 23.
